...
This policy defines what benchmark numbers are allowed in release-facing docs, PRs, and announcements.
...
6. Comparator adapter shows valid end-to-end behavior (published/consumed/errors sanity)
...
Additional systems (Redis, Pulsar, Redpanda, etc.) can be included in appendices.
